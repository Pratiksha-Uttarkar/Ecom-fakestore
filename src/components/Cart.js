...
const Cart = () => {
          ...
          <div className="row justify-content-center">
            ...
            <div className="col-md-4">
              ...
              <h4 style={{ paddingTop: "120px", paddingLeft: "150px" }}>
                Sub Total :${(tempPrice = cartItem.price * cartItem.qty)}
              </h4>
            </div>
          </div>
        </div>
  ...
  const button = () => {
    return (
      <div style={{display:'flex', alignItems:'flex-start', width:'13%',paddingTop:"2%"}}>
        <button className="btn btn-outline-dark me-2" onClick={() => navigate("/checkout")}>
          Proceed To checkout
        </button>
      </div>
    );
